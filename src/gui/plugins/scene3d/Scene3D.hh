...
inline namespace IGNITION_GAZEBO_VERSION_NAMESPACE {
  ...
  class Scene3D : public ignition::gazebo::GuiSystem
  {
    ...
    /// \brief Callback for view transparent request
    /// \param[in] _msg Request message to set the target to view transparent
    /// \param[in] _res Response data
    /// \return True if the request is received
  ...
  class IgnRenderer : public QObject
  {
    ...
    /// \brief Toggle view transparency of the specified target
    /// \param[in] _target Target to toggle view transparency
